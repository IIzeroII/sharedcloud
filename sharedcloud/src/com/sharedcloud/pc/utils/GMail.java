...
public class GMail {
	...
	private  String propsPath = "conf/pc/config.properties";
	...
	public void setPropsPath(String propsPath) {
		...
		this.props = GUtils.loadProps(propsPath);
	}
	
	public static void main(String[] args) {
		try {
			new GMail().sendMessage("1138829222@qq.com","云共享", "您好!");
		} catch (MessagingException e) {
			e.printStackTrace();
		}
	}
